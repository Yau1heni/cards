...
export const selectPacksMaxCount = (state: AppRootStateType) => state.packs.maxCardsCount
export const selectPacksMinCount = (state: AppRootStateType) => state.packs.minCardsCount
